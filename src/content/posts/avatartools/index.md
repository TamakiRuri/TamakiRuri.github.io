...
### Face Tune（表情作成・設定ツール）

[Github](https://github.com/Tliks/FaceTune)

無料

自作FXなど広く使える表情作成ツールです。WD無効は非対応だが、それでもかなり使いやすいと思います。

Betaのため、VCCまたはAlcomの設定でプレリリース版の表示を許可してから導入する必要があります。
...
[AAOと同じREPOにあります](#aao-avatar-optimizer)

無料

アバターを複数体同時にアップロードするツールです。プロフは毎回必要なわけではなく、アップロードのときにドラッグ＆ドロップを使えば十分だと思います。
<br>
...
アバターに詰め込める飛行システムです。使いやすかったが、アップデートですこし使いにくくなってしまいました。

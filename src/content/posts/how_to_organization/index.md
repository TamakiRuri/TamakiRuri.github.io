...
また、ぶいちゃの組織、あるいはコミュニティは、ぶいちゃがルーズな環境であることを認識し、実在する企業とは目的も、人材も違うこと（特に、営利活動しない/できない、あるいは法人化する予定がない場合）、そしてこれによって、適切でない管理方法もあることがあることを認識しなければならない。
...
組織であれば、メンバー個人にメリットがなければならないことを心掛けましょう。特に、非営利の場合ではメンバーが金銭的、政治的な利益を求めていないということは、ほかの利益を得られるように活動しなければならない。メンバーによって、メリットが少ない場合もありますので、注意すべきです。メリットがなければ、メンバーを留めることができなくなります。
